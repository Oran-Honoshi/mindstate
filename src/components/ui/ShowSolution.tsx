          ...
          <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}
            ...
            <motion.div initial={{scale:0.9,y:20}} animate={{scale:1,y:0}} exit={{scale:0.9,y:20}}
              ...
              <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:16}}>
                ...
                <div>
                  <h3 style={{fontSize:16,fontWeight:700,color:"var(--text1)",marginBottom:2}}>Show Solution?</h3>
              ...
              <div style={{background:"rgba(239,68,68,0.06)",borderRadius:14,padding:"12px 14px",marginBottom:18,border:"0.5px solid rgba(239,68,68,0.15)"}}>
                <p style={{fontSize:13,color:"var(--text2)",lineHeight:1.6}}>
                  Revealing the solution will reduce your XP to <strong style={{color:"#EF4444"}}>1 point</strong> for this stage. Use it to learn — then try again for a real score.
                </p>
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:10,paddingTop:10,borderTop:"0.5px solid rgba(239,68,68,0.15)"}}>
                  <span style={{fontSize:11,color:"var(--text4)"}}>Current XP</span>
                  <span style={{fontSize:16,fontWeight:700,color:"var(--text1)",fontFamily:"Georgia,serif"}}>{currentXP} → 1</span>
                </div>
              </div>
