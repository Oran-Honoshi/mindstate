...
export default function OfflinePage() {
  return (
    <div style={{ minHeight:"100vh", background:"#0F0F14", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:16, padding:24, textAlign:"center" }}>
      ...
      <h1 style={{ fontSize:28, fontWeight:700, color:"white", fontFamily:"var(--font-sans)" }}>You're Offline</h1>
      ...
      <button onClick={() => window.location.reload()}
        style={{ padding:"12px 28px", borderRadius:14, border:"none", background:"linear-gradient(135deg,var(--color-accent-primary),var(--color-accent-primary))", color:"white", fontSize:14, fontWeight:700, cursor:"pointer" }}>
        Try Again
      </button>
    </div>
  );
