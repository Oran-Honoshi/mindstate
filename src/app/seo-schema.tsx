...
const FAQ_DATA = [
  ...
  { q: "Is MindElement appropriate for young children?",
  ...
  { q: "Can the games help older adults maintain mental agility?",
    a: "Yes. Regular engagement with algorithmic logic puzzles exercises fluid intelligence, visual working memory, and cognitive pattern-tracking. MindElement also includes an Accessibility Mode with larger touch targets and optional timer-free play, designed for comfortable daily use at any age." },
  ...
  { q: "Does it work offline?",
    a: "Yes. MindElement is a Progressive Web App. Install it to your home screen and play without an internet connection." },
  ...
  { q: "What languages does MindElement support?",
    a: "MindElement supports 7 languages: English, Spanish, German, French, Portuguese, Dutch, and Hebrew with full right-to-left layout." },
  { q: "Is MindElement good for brain training?",
    a: "MindElement covers 24 logic disciplines spanning spatial reasoning, numerical logic, memory, and pattern recognition. Daily practice across disciplines supports cognitive fitness for children, professionals, and seniors alike." },
];
...
export function OrganizationSchema() {
  const schema = {
    ...
    "description": "MindElement is a minimalist brain-training PWA for children, professionals, and seniors — 24 logic games, 100 stages each, ad-free.",
    "sameAs": [],
  };
  return (
    <script
...
export function HowToSchema() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "How to play MindElement brain training games",
    "description": "Get started with MindElement in 3 steps",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Choose a game",
