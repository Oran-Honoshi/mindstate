...
function shareResult(stage:number,score:number,best:number){const text=` MindState · 2048 Pro Stage ${stage} · Score: ${score} · Best tile: ${best}`;const url="https://mindstate.app";if(navigator.share)navigator.share({title:"MindState",text,url}).catch(()=>{});else window.open("https://twitter.com/intent/tweet?text="+encodeURIComponent(text+" "+url),"_blank");}
