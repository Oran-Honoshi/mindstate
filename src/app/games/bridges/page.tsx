...
export default function BridgesGame(){
  ...
  const loadStage=useCallback((s:number)=>{
    ...
    setBoard(b);setPlaced([]);setXpState(xp);setCompleted(false);setFinalXP(0);setElapsed("00:00");
  ...
  return(
    <div style={{minHeight:"100vh",background:"#FDFCFB",display:"flex",flexDirection:"column"}}>
      ...
      <main style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",padding:"76px 16px 32px",gap:18}}>
        ...
        <div style={{fontSize:11,color:"#94A3B8"}}>Click between islands to add bridges · Each island shows its required count</div>
