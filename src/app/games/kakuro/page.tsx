  ...
  return (
    <div style={{ minHeight:"100vh", background:"var(--color-bg)", display:"flex", flexDirection:"column" }}>
      ...
      <main style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", padding:"76px 16px 32px", gap:18 }}>
        <div style={{ width:"100%", maxWidth:500, background:"var(--color-surface)", borderRadius:20, border:"0.5px solid var(--color-border)", padding:"16px 20px", boxShadow:"0 2px 8px rgba(0,0,0,0.04)" }}>
        ...
        <div style={{ fontSize:11, color:"var(--color-text-secondary)" }}>Fill white cells · Each run must sum to its clue · No repeats in a run</div>
              ...
              return (
                <motion.button key={`${r}-${c}`}
                  ...
                  style={{ width:cellSize, height:cellSize, display:"flex", alignItems:"center", justifyContent:"center",
                    ...
                    background: isSolution?"rgba(239,68,68,0.04)":isSelected?"#EEF2FF":hasError?"#FEF2F2":"var(--color-surface)",
