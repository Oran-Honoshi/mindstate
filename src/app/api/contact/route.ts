...
export async function POST(req: Request) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:32px;background:#FAFAF9;border-radius:16px;">
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
            ...
            <tr><td style="padding:8px 0;font-size:13px;color:#64748B;">Email</td><td style="padding:8px 0;font-size:14px;color:#4F6EF7;"><a href="mailto:${email}">${email}</a></td></tr>
