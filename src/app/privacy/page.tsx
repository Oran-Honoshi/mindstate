...
export const metadata: Metadata = {
  ...
  description: "MindState Privacy Policy — how we collect, use, and protect your data.",
};
    ...
    <div className="min-h-screen bg-[#F9FAFB]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        {[
          ...
          { title:"2. How We Use Your Information", body:`Your data is used to: provide and personalise the MindState service, save your progress and scores, send essential product emails (account confirmation, password reset), and display leaderboard rankings. We never use your data for advertising.` },
          ...
          { title:"5. Children's Privacy", body:`MindState is intended for users aged 13 and older. We do not knowingly collect personal information from children under 13. If you believe a child has provided us personal data, please contact us immediately.` },
          { title:"6. Your Rights (GDPR & CCPA)", body:`You have the right to: access your personal data, correct inaccurate data, delete your account and all associated data, export your data in machine-readable format, and object to processing. To exercise these rights, email privacy@mindstate.app.` },
          ...
          { title:"9. Changes to This Policy", body:`We may update this Privacy Policy from time to time. We will notify you of significant changes via email. Continued use of MindState after changes constitutes acceptance of the updated policy.` },
          { title:"10. Contact", body:`For privacy-related questions: privacy@mindstate.app` },
        ].map((section, i) => (
