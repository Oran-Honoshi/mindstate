    ...
    return (
      <div className="min-h-screen bg-[#121212] flex flex-col items-center justify-center px-4">
        <motion.div
          ...
          className="w-full max-w-sm text-center bg-neutral-900 border border-neutral-800 rounded-2xl p-10"
        >
          <div className="w-14 h-14 rounded-full bg-cyan-400/10 border border-cyan-400/30 flex items-center justify-center mx-auto mb-5">
    ...
    <div className="min-h-screen bg-[#121212] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8">
          ...
          <p className="text-sm text-neutral-500 mb-7">Start training for free</p>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              <label className="text-xs font-mono text-neutral-500 tracking-wider mb-1.5 block">USERNAME</label>
              <input
                type="text"
                value={username}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-cyan-400 text-black font-mono font-bold text-sm tracking-wider rounded-lg hover:bg-green-400 transition-colors disabled:opacity-50"
            >
        ...
        <p className="text-center text-sm text-neutral-600 mt-6">
          ...
          <Link href="/auth/signin" className="text-cyan-400 hover:text-white transition-colors">
            Sign in
          </Link>
        </p>
      </motion.div>
