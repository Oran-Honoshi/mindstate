...
export default function SignInPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#FDFCFB", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"24px" }}>
      <motion.div initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.4 }} style={{ width:"100%", maxWidth:380 }}>
        ...
        <div style={{ background:"white", borderRadius:24, border:"0.5px solid rgba(0,0,0,0.08)", padding:"32px 28px", boxShadow:"0 4px 24px rgba(0,0,0,0.06)" }}>
          <h1 style={{ fontSize:22, fontWeight:700, color:"#1C1917", fontFamily:"Georgia,serif", marginBottom:4 }}>Welcome back</h1>
          <p style={{ fontSize:13, color:"#64748B", marginBottom:24 }}>Sign in to continue training</p>
